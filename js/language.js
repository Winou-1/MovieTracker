...
const translations = {
    fr: {
        ...
        // Search
        search_title: 'Découvre et note tes films préférés',
        ...
        movies_no_results: 'Aucun film trouvé',
        movies_watchlist_badge: 'À voir',
        ...
        profile_stats_watchlist: 'À voir',
        profile_liked: 'Films aimés',
        profile_to_watch: 'À voir',
        profile_recently_watched: 'Vus récemment',
        ...
        filter_title_asc: 'Titre (A → Z)',
        filter_title_desc: 'Titre (Z → A)',
        filter_date_asc: 'Date de sortie (croissant)',
        filter_date_desc: 'Date de sortie (décroissant)',
        filter_added_desc: 'Récemment ajouté',
        
        // Toasts
        toast_added_watchlist: 'Ajouté à la watchlist',
        toast_removed_watchlist: 'Retiré de la watchlist',
        toast_marked_watched: 'Marqué comme vu',
        toast_removed_watched: 'Retiré des films vus',
    ...
    en: {
        ...
        filter_reset: 'Reset',
        filter_title_asc: 'Title (A → Z)',
        filter_title_desc: 'Title (Z → A)',
    ...
    es: {
        ...
        auth_have_account: '¿Ya registrado?',
        auth_forgot_password: '¿Olvidaste tu contraseña?',
        auth_logout: 'Cerrar sesión',
        
        // Search
        search_title: 'Descubre y califica tus películas favoritas',
        search_placeholder: 'Buscar una película...',
        search_button: 'Buscar',
        
        // Movies
        movies_popular: 'Películas Populares',
        movies_loading: 'Cargando...',
        movies_error: 'Error al cargar películas',
        movies_no_results: 'No se encontraron películas',
        ...
        profile_stats_reviews: 'Reseñas',
        profile_stats_favorites: 'Favoritas',
        profile_stats_watchlist: 'Por Ver',
        profile_liked: 'Películas Favoritas',
        profile_to_watch: 'Por Ver',
        profile_recently_watched: 'Vistas Recientemente',
        profile_no_movies: 'Aún no hay películas',
        profile_explore: '¡Explora y añade películas!',
        ...
        modal_cast: 'Reparto',
        modal_similar: 'También te gustará',
        modal_collection: 'Otras películas de la saga',
        modal_no_synopsis: 'Sin sinopsis disponible.',
        
        // Actions
        action_trailer: 'Tráiler',
        ...
        filter_genre: 'Género:',
        filter_all_genres: 'Todos los géneros',
        filter_grid_size: 'Pósters por fila:',
        filter_reset: 'Restablecer',
        filter_title_asc: 'Título (A → Z)',
        filter_title_desc: 'Título (Z → A)',
        filter_date_asc: 'Fecha de estreno (ascendente)',
        filter_date_desc: 'Fecha de estreno (descendente)',
        filter_added_desc: 'Añadido recientemente',
        
        // Toasts
        toast_added_watchlist: 'Añadido a la lista',
...
// Fonction pour ouvrir le modal de sélection de langue
            ...
            <div class="settings-body">
                <div class="language-options">
                    <div class="language-option ${currentLang === 'fr' ? 'active' : ''}" onclick="selectLanguage('fr')">
                        ...
                        ${currentLang === 'fr' ? '<span class="language-check">✓</span>' : ''}
                    </div>
                    ...
                    <div class="language-option ${currentLang === 'es' ? 'active' : ''}" onclick="selectLanguage('es')">
                        ...
                        ${currentLang === 'es' ? '<span class="language-check">✓</span>' : ''}
                    </div>
                </div>
            </div>
        </div>
